...
const EditRankPromotionRequirementModal = ({
                                               requirement,
                                               ranks,
                                               requirementTypes,
                                               roles,
    ...
    useEffect(() => {
        if (requirement) {
            setFormData({
                ...
                value_required: requirement.value_required || 0,
                unit_type: requirement.unit_type || '',
                position_role: requirement.position_role || '',
                position_category: requirement.position_category || '',
                required_certification: requirement.required_certification || '',
                certification_category: requirement.certification_category || '',
                required_mos_level: requirement.required_mos_level || '',
                is_mandatory: requirement.is_mandatory !== undefined ? requirement.is_mandatory : true,
                ...
                waiverable: requirement.waiverable || false,
                waiver_authority: requirement.waiver_authority || ''
            });

            // Set selected type based on requirement
            if (requirement.requirement_type_details) {
                setSelectedType(requirement.requirement_type_details);
            }
        }
    }, [requirement]);
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            onUpdate(requirement.id, submitData);
        }
    };
        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content large" onClick={(e) => e.stopPropagation()}>
                <div className="modal-header">
                    <h2>
                        <Award size={20} />
                        Edit Rank Promotion Requirement
                    </h2>
...
export default EditRankPromotionRequirementModal;