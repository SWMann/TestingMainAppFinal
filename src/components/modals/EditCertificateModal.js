...
const EditCertificateModal = ({ certificate, branches, ranks, onClose, onUpdate }) => {
    const [formData, setFormData] = useState({
        ...
        is_required_for_promotion: certificate.is_required_for_promotion || false,
        min_rank_requirement: certificate.min_rank_requirement || '',
        expiration_period: certificate.expiration_period || '',
        authorized_trainers: certificate.authorized_trainers || []
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await onUpdate(certificate.id, submitData);
        } catch (error) {
            ...
            <div className="modal-content large" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="modal-body">
                        ...
                        {certificate.active_holders_count > 0 && (
                            <div className="update-warning">
                                <Shield size={16} />
                                <p>
                                    This certificate has been issued to {certificate.active_holders_count} user(s).
                                    Changes will affect all current and future holders.
                                </p>
                            </div>
                        )}
                    </div>
