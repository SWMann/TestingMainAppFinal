...
const EditStandardModal = ({ standard, subGroups, onClose, onUpdate }) => {
    ...
    useEffect(() => {
        if (standard) {
            setFormData({
                ...
                standard_sub_group: standard.standard_sub_group || '',
                content: standard.content || '',
                summary: standard.summary || '',
                pdf_url: standard.pdf_url || '',
                video_url: standard.video_url || '',
                image_urls: standard.image_urls || [],
                version: standard.version || '1.0',
                status: standard.status || 'Draft',
                difficulty_level: standard.difficulty_level || 'Basic',
                is_required: standard.is_required || false,
                tags: standard.tags || [],
                related_standards: standard.related_standards || [],
                related_training: standard.related_training || []
            });
        }
    }, [standard]);
            ...
            <div className="modal-content xlarge" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className="modal-form">
                    ...
                    <div className="warning-message">
                        <AlertCircle size={18} />
                        <span>
                            Changes to this standard will be saved immediately. If this is an active standard, 
                            users will see the updated version right away.
                        </span>
                    </div>
